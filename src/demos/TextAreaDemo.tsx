...
import type { TNJSizeProp, TNJTextSizeProp, TNJVariantProp, TNJRoundedProp, TNJBorderProp, TNJResizeProp } from '../types/props'
  ...
  return (
    <section className='textarea-demo'>
      ...
      <div className='prop-wrapper'>
        ...
        <select id='resize' name='resize' value={selectedResize} onChange={(e) => setSelectedResize(e.target.value as TNJResizeProp)}>
          {resizeValues}
        </select>
      </div>
